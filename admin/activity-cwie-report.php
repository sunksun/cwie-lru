    ...
    <div class="container">
        ...
        <div class="activity-section">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    // สร้างเงื่อนไขการกรองตามสิทธิ์ผู้ใช้
                    $where_condition = "activity_type = 'กิจกรรมนักศึกษา'";
                    if ($username != 'admin') {
        ...
        <div class="activity-section">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    // สร้างเงื่อนไขการกรองตามสิทธิ์ผู้ใช้
                    $where_condition = "activity_type = 'กิจกรรมอาจารย์'";
                    if ($username != 'admin') {
                        $where_condition .= " AND faculty_id = '$faculty_id'";
                    }
                    if (isset($_GET['year']) && !empty($_GET['year'])) {
        ...
        <div class="activity-section">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    // สร้างเงื่อนไขการกรองตามสิทธิ์ผู้ใช้
                    $where_condition = "activity_type = 'กิจกรรมร่วมกับสถานประกอบการ'";
                    if ($username != 'admin') {
                        $where_condition .= " AND faculty_id = '$faculty_id'";
                    }
                    if (isset($_GET['year']) && !empty($_GET['year'])) {
