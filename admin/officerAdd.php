...
<head>
  ...
  <title>Admin | จัดการข้อมูลเจ้าหน้าที่</title>
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><a href="#">เพิ่มข้อมูลเจ้าหน้าที่</a></h3>
              ...
              <div class="card-body">
                <form action="officerSave.php" method="post" enctype="multipart/form-data">
                    ...
                    <select class="form-control select2" name="fid" style="width: 100%;" required>
                      ...
                      if ($result->num_rows > 0) {
                        while ($optionData = $result->fetch_assoc()) {
                          ...
                          $fid = $optionData['fid'];
                      ?>
                          <option value="<?php echo $fid; ?>"><?php echo $option; ?></option>
                      <?php
                        }
                      }
                      ?>
                  ...
                  <div class="row form-group">
                    <div class="col-4">
                      ...
                      <input type="eamil" name="useremail" class="form-control" required>
                    </div>
                    <div class="col-4">
                ...
                ?>
                    <tr>
                      ...
                      <td class="project-actions text-right">
                        ...
                        <a class="btn btn-info btn-sm" href="officerEdit.php?offid=<?php echo $row["id"]; ?>">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                        </a>
                        <a class="btn btn-danger btn-sm" href="JavaScript:if(confirm('ยืนยันการลบข้อมูล?')==true){window.location='officerDel.php?offid=<?php echo $row["id"]; ?>';}">
