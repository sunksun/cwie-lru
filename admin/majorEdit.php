  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<?php
		$majid = $_GET["majid"];
		$sql = "SELECT * FROM major WHERE id = '$majid'";
		$result = $conn->query($sql);
		$row = $result->fetch_assoc()
		?>
        <div class="card-body">
         <form action="majorSave.php?majid=<?php echo $row["id"]; ?>" method="post" enctype="multipart/form-data">
		    ...
		    <div class="form-group">
                ...
                <input type="text" name="major" id="inputClientCompany" class="form-control" value="<?php echo $row["major"]; ?>">
              </div>
             </div>
            <!-- /.card-body -->
           </div>
