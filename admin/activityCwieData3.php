...
if ($column_exists) {
    ...
    $sql = "SELECT * FROM `activity_cwie` WHERE activity_type = 'กิจกรรมร่วมกับสถานประกอบการ' AND faculty_id = '$faculty_id' AND year = '$year'";
} else {
    // ถ้าไม่มีคอลัมน์ year ให้ดึงข้อมูลตาม faculty_id และ activity_type อย่างเดียว
    $sql = "SELECT * FROM `activity_cwie` WHERE activity_type = 'กิจกรรมร่วมกับสถานประกอบการ' AND faculty_id = '$faculty_id'";
}
