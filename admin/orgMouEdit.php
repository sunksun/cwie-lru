        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><a href="#">แก้ไขสถานประกอบการ</a></h3>
			...
			<div class="row form-group">
			 ...
			 <div class="row form-group">
                  <div class="col-6">
                    ...
                    <?php if($option == $row["province"]) echo 'selected="selected"'; ?>
                    >
      ...
      <div class="col-2">
          ...
          <select id="inputState" class="form-control" name="date_mou1">
            ...
            <?php
              ...
              ?>
              <option value="<?php echo $option; ?>"
              <?php if($option == $day) echo 'selected="selected"'; ?>
              >
                <?php echo $option; ?></option>
              <?php
                }
          ...
          <select id="inputState" class="form-control" name="date_mou2">
            ...
            <?php
              ...
              ?>
              <option value="<?php echo $option; ?>"
              <?php if($option == $mount) echo 'selected="selected"'; ?>
              >
                <?php echo $option; ?></option>
              <?php
                }
          ...
          <select id="inputState" class="form-control" name="date_mou3">
            ...
            <?php
              ...
              ?>
              <option value="<?php echo $option; ?>"
              <?php if($option == $year) echo 'selected="selected"'; ?>
              >
                <?php echo $option; ?></option>
              <?php
                }
