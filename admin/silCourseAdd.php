...
<head>
  ...
  <title>Admin | จัดการรูปแบบการจัดการเรียนรู้การปฏิบัติงานในสถานศึกษา</title>
...
<body class="hold-transition sidebar-mini">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><a href="#">รูปแบบการจัดการเรียนรู้การปฏิบัติงานในสถานศึกษา (SIL)</a></h3>
              ...
              <div class="card-body">
                <form action="silCourseSave.php" method="post" enctype="multipart/form-data">
                ...
                ?>
                    <tr>
                      ...
                      <td class="project-actions text-right">
                        <a class="btn btn-info btn-sm" href="silCourseEdit.php?cwieCoid=<?php echo $row["id"]; ?>">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                        </a>
                        <a class="btn btn-danger btn-sm" href="JavaScript:if(confirm('ยืนยันการลบข้อมูล?')==true){window.location='silCourseDel.php?cwieCoid=<?php echo $row["id"]; ?>';}">
  ...
  <script>
    $(function() {
      ...
      // Function to open silCourseReport.php
      function openSilCourseReport() {
        window.location.href = 'silCourseReport.php';
      }
