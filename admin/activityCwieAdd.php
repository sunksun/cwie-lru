  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><a href="#">เพิ่มกิจกรรมการจัดการเรียนรู้หลักสูตรสหกิจศึกษาฯ (CWIE) | การจัดการเรียนรู้การปฏิบัติงานในสถานศึกษา (SIL) ปีการศึกษา <?php echo $year; ?></a></h3>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">รายการกิจกรรมหลักสูตรสหกิจศึกษาฯ (CWIE) | การจัดการเรียนรู้การปฏิบัติงานในสถานศึกษา (SIL) ปีการศึกษา <?php echo $year; ?></h3>
