...
<head>
  ...
  <title>Admin | ข้อมูลนักศึกษา CWIE LRU</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>จัดการนักศึกษา CWIE Highlight</h1>
            </div>
            <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><a href="#">เพิ่มนักศึกษา CWIE Highlight</a></h3>
              ...
              <div class="card-body">
                <form action="stu-highlightSave.php" method="post" enctype="multipart/form-data">
                  <div class="row form-group">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="faculty" style="width: 100%;" required>
                  ...
                  <div class="form-group">
                    <label for="inputName">รูปภาพ (ขนาด 570x690px)</label>
