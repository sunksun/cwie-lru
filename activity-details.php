...
<head>
    <meta charset="utf-8">
    <title>รายละเอียดกิจกรรม | CWEI LRU</title>
    <!-- Stylesheets -->
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="blog-details__left">
                            <div class="blog-details__img">
                                <img src="./admin/img_act/1024x683_<?php echo $row["filename"]; ?>" alt="">
                                <div class="blog-details__date">
                                    <span class="day"><?php echo $date; ?></span>
                                    <span class="month"><?php echo $mou_year; ?></span>
                                </div>
                            </div>
                            <div class="blog-details__content">
                                <h3 class="blog-details__title"><?php echo $row["activity_name"]; ?></h3>
                                <p class="blog-details__text-2"><?php echo $row["details"]; ?></p>
                            </div>
                        </div>
                    </div>
